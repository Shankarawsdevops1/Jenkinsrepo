...
aws s3 cp s3://jenkins-test-8/java_code9/$tag/hello-world-0.0.1-SNAPSHOT.war .
scp  hello-world-0.0.1-SNAPSHOT.war ec2-user@${IP}:/home/ec2-user/tomcat/apache-tomcat-9.0.64/webapps
